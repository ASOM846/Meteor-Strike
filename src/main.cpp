...
int main() {
    ...
    RenderTexture2D target = LoadRenderTexture(static_cast<int>(renderWidth), static_cast<int>(renderHeight));
    ...
    Button upgradeLaserCount(screenWidth / 2 - 150, screenHeight / 2 + 20, 300, 50, "Upgrade Laser Count");
    Button backToMenu(screenWidth / 2 - 250, screenHeight / 2 - 100, 400, 70, "Back to Menu");
    Button upgradeMaxLives(screenWidth / 2 - 150, screenHeight / 2 + 80, 300, 50, "Upgrade Max Lives");
    ...
    while (WindowShouldClose() == false) {
        ...
        upgradeMaxLives.SetPosition(screenWidth / 2 - 150, screenHeight / 2 + 80);
        backToMenu.SetPosition(screenWidth / 2 - backToMenu.GetWidth() / 2, screenHeight / 2 + 250);
        upgradeLaserCount.SetPosition(screenWidth / 2 - 150, screenHeight / 2 + 20);
        ...
        case 3: // Upgrades mode
            ...
            backToMenu.Update();
            upgradeLaserCount.Update();
            upgradeMaxLives.Update();
            ...
            // Wy?wietlanie informacji o poziomach i pieniÕdzach w jednej linii
            ...
            DrawText(TextFormat("Max Lives: %i", game.GetMaxLives()), 750, 10, 30, YELLOW);
            ...
            DrawText("Cost: 300", upgradeMaxLives.GetX() + upgradeMaxLives.GetWidth() + 10, upgradeMaxLives.GetY() + 10, 20, YELLOW);
            ...
            if (upgradeMaxLives.IsClicked()) {
                game.UpgradeMaxLives();
            }

            DrawText(TextFormat("Cost: %i", game.GetLaserUpgradeCost()), upgradeLaserCount.GetX() + upgradeLaserCount.GetWidth() + 10, upgradeLaserCount.GetY() + 10, 20, YELLOW);

            if (upgradeLaserCount.IsClicked()) {
                game.UpgradeLaserCount();
            }
